  ...
  const translateToEnglish = useCallback(async (
    ...
    try {
      ...
      const textsToTranslate = [
        ...
        currentFormData.phrase || '',
        currentFormData.credits || '',
      ...
      if (translations && translations.length > 0) {
        ...
        const newEnglishData = {
          ...
          // Map phrase
          phrase: currentFormData.phrase && currentFormData.phrase.trim() ? translations[translationIndex++] : '',
          // Map credits
          credits: currentFormData.credits && currentFormData.credits.trim() ? translations[translationIndex++] : '',
          // Map categories
