import { FundadorFormData } from '@/hooks/useFundadorForm'
import { validateImagesForContentType } from '@/utils/imageValidationUtils'

export const createFundadorFormHandlers = (
  formData: FundadorFormData,
  setFormData: React.Dispatch<React.SetStateAction<FundadorFormData>>,
  formDataEnglish: FundadorFormData,
